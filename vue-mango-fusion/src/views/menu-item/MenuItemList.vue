<template>
    <div class="container px-3">
        ...
        <div v-else>
            ...
            <button class="btn btn-success btn-sm gap-2 rounded-1 px-4 py-2" @click="router.push({name: APP_ROUTE_NAMES.CREATE_MENU_ITEM})">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <tr v-for="menuItem in menuItems" :key="menuItem.id">
                            ...
                            <td class="fw-semibold small">$ {{ menuItem.price }}</td>
                            <td>
                                <span class="badge bg-info bg-opacity-10 text-info small"> {{ menuItem.specialTag }} </span>
                            </td>
