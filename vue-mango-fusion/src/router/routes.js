...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/orders-list', name: APP_ROUTE_NAMES.ORDER_LIST, component: OrderList, beforeEnter: [requireAuth] },
    { path: '/admin/manage-orders', name: APP_ROUTE_NAMES.MANAGE_ORDER_ADMIN, component: ManageOrder, beforeEnter: [requireAdmin] },
    { path: '/order-confirmation/:id', name: APP_ROUTE_NAMES.ORDER_CONFIRM, component: OrderConfirmation, props: true, beforeEnter: [requireAuth] },
